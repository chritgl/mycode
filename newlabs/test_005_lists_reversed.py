...
# Print the elements in the original list
print("Item 1 in the list:  " , a_list[0]) # Stored at index 0
print("Item 2 in the list:  " , a_list[1]) # Stored at index 1
print("Item 3 in the list:  " , a_list[2]) # Stored at index 2
print("Item 4 in the list:  " , a_list[3]) # Stored at index 3
print()
